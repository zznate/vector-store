 ...
 * phase. Maps to HTTP 501 with the structured error body.
 */
public final class NotImplementedException extends VectorStoreException {

  public NotImplementedException(String operation, int phaseNumber) {
    super(
        Status.NOT_IMPLEMENTED,
        "not_implemented",
        "%s lands in phase %d".formatted(operation, phaseNumber));
  }
}
